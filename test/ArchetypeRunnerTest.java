...
import io.intino.archetype.ArchetypecRunner;
...
public class ArchetypeRunnerTest {
	private String home;
	...
	private static String configurationWorkspace(String home) {
		try {
			InputStream stream = ArchetypeRunnerTest.class.getResourceAsStream("/workspace.txt");
